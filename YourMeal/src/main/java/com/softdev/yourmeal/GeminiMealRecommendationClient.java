...
public class GeminiMealRecommendationClient {
    ...
    // Gemini model name — this is NOT an environment variable
        ...
        try {
            String requestJson =
                    objectMapper.writeValueAsString(
                            buildRequest(profile, restrictions)
                    );
    ...
    public GroceryListResult recommendIngredients(
        ...
        try {
            String requestJson =
                    objectMapper.writeValueAsString(
                            buildIngredientsRequest(savedMealNames)
                    );
