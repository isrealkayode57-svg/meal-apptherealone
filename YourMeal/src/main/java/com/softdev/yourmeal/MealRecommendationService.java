...
public class MealRecommendationService {
    ...
    public MealRecommendationService(
            GeminiMealRecommendationClient geminiMealRecommendationClient
    ) {
        this.geminiMealRecommendationClient =
                geminiMealRecommendationClient;
    }
    ...
    public MealRecommendationResult recommendMeals(
        ...
        return geminiMealRecommendationClient.recommendMeals(
                profile,
                restrictions
        );
    }
    ...
    public GroceryListResult recommendIngredients(
        ...
        return geminiMealRecommendationClient
                .recommendIngredients(savedMealNames);
    }

    public List<String> describeRestrictions(
            DietaryProfile profile
    ) {
        ...
        addIf(
                restrictions,
                profile.isKidneyDisease(),
                "Kidney disease-aware"
        );
